...
/**
 * 配置公共参数 创建者 科帮网 创建时间 2017年7月27日
 */
public final class AliPayConfig {
	...
	private static class SingletonHolder {
		 ...
		 * 静态初始化器，由JVM来保证线程安全
		 */
		private static AlipayClient alipayClient = new DefaultAlipayClient(Configs.getOpenApiDomain(),
				Configs.getAppid(), Configs.getPrivateKey(), PARAM_TYPE, CHARSET, Configs.getAlipayPublicKey(), "RSA2");
	 ...
	 * @Author 科帮网
	 * @return AlipayClient
	 * @Date 2017年7月27日 更新日志 2017年7月27日 科帮网 首次创建
	 *
	 */
